    ...
    <div className="settings-panel animate-fade">
      ...
      >
          ...
          <div className="setting-item" style={{ marginBottom: '16px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <input
                ...
                onChange={(e) =>
                  setSettings((prev) => ({ ...prev, minMargin: parseFloat(e.target.value) }))
                }
                style={{
                  flex: 1,
                  padding: '12px',
          ...
          <div className="setting-item">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <input
                ...
                onChange={(e) =>
                  setSettings((prev) => ({ ...prev, criticalMargin: parseFloat(e.target.value) }))
                }
                style={{
                  flex: 1,
                  padding: '12px',
        ...
        <div
          ...
          style={{ padding: '0', gridColumn: 'span 2', overflow: 'hidden' }}
        >
          <SecurityFortress />
        </div>
        ...
        <div className="settings-card glass" style={{ padding: '24px' }}>
          ...
          <p
            className="text-muted"
            style={{ marginTop: '16px', fontSize: '0.75rem', textAlign: 'center' }}
          >
