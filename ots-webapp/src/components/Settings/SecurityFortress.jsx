          ...
          <div className="space-y-4">
            ...
            <div className="bg-slate-900/50 rounded-lg max-h-48 overflow-y-auto border border-white/5">
              {whitelistedIPs.map((ip) => (
                <div
                  key={ip}
                  className="flex justify-between items-center p-3 border-b border-white/5 hover:bg-white/5"
                >
            ...
            {securityAlerts.length === 0 ? (
              ...
              <div className="space-y-2 h-48 overflow-y-auto pr-2">
                {securityAlerts.map((alert) => (
                  <div
                    key={alert.id}
                    className="bg-red-500/10 border border-red-500/20 p-3 rounded text-sm"
                  >
