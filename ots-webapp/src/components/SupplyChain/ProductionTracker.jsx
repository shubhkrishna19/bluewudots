        ...
        <div className="glass" style={{ padding: '24px' }}>
          ...
          {prediction && (
            ...
            >
              ...
              <span
                style={{
                  fontSize: '0.7rem',
                  color: prediction.riskLevel === 'HIGH' ? 'var(--danger)' : 'var(--success)',
                }}
              >
          ...
          <div className="form-group" style={{ marginBottom: '20px' }}>
            <label
              ...
              style={{ fontSize: '0.8rem', display: 'block', marginBottom: '8px' }}
            >
              SELECT PRODUCT (SKU)
            </label>
            <select
            ...
            {qcReport && (
              <div
                ...
                style={{
                  ...
                  padding: '10px',
                  fontSize: '0.75rem',
                  border: `1px solid ${qcReport.status === 'VERIFIED' ? 'var(--success)' : 'var(--danger)'}`,
                }}
              >
