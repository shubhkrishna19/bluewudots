              ...
              <div className="space-y-3 mt-6">
                ...
                {packingStatus.verified.map((sku, i) => (
                  ...
                  >
                    ...
                    <span className="font-mono text-green-100 line-through decoration-green-500/50">
                      {sku}
                    </span>
                ...
                {packingStatus.missing.map((sku, i) => (
                  <div
                    key={`m-${i}`}
                    className="flex items-center gap-3 p-3 bg-white/5 border border-white/10 rounded-lg animate-pulse"
                  >
