        ...
        <div className="dealer-portal animate-fade">
            <div className="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p className="text-slate-400">Welcome back, {user.name} | <span className="text-purple-400 font-semibold">{stats.tier} Partner</span></p>
                </div>
                <div className="flex gap-4">
                    <div className="glass p-4 text-right min-w-[150px]">
                        <span className="text-[10px] text-slate-500 uppercase block font-bold">Volume (MTD)</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="glass p-6 flex items-center gap-4 cursor-pointer hover:bg-white/5 transition-colors" onClick={() => setView('order')}>
                    <div className="p-3 bg-purple-500/20 rounded-lg text-purple-400"><ShoppingBag /></div>
                    <div>
                ...
                <div className="glass p-6 flex items-center gap-4">
                    <div className="p-3 bg-blue-500/20 rounded-lg text-blue-400"><CreditCard /></div>
                    <div>
                ...
                <div className="glass p-6 flex items-center gap-4">
                    <div className="p-3 bg-green-500/20 rounded-lg text-green-400"><LayoutDashboard /></div>
                    <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="glass p-6">
                        <div className="flex justify-between items-center mb-6">
                            <h3 className="flex items-center gap-2"><History className="w-5 h-5" /> Recent Orders</h3>
                ...
                <div className="space-y-6">
                    <div className="glass p-6">
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center text-sm">
                                ...
                                <span className="px-3 py-1 bg-yellow-500/20 text-yellow-500 rounded-full font-bold text-xs">{stats.tier}</span>
                            </div>
                            <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden">
                                <div
                                    className="bg-purple-500 h-full transition-all"
                                    style={{ width: stats.tier === 'PLATINUM' ? '100%' : stats.tier === 'GOLD' ? '66%' : '33%' }}
                                />
                            </div>
                    ...
                    <div className="glass p-6 bg-gradient-to-br from-purple-600/10 to-transparent">
                        ...
                        <p className="text-xs text-slate-400 mb-4 leading-relaxed">Dedicated account manager is available for bulk order customizations and special logistics requests.</p>
