      ...
      <div className="glass p-4 mt-6 flex justify-between items-center">
        <div>
          <h3 className="text-lg font-bold flex items-center gap-2">
            ...
            <span
              className={`text-xs px-2 py-0.5 rounded ${marketplaceSyncService.isAmazonLive ? 'bg-green-500/20 text-green-400' : 'bg-yellow-500/20 text-yellow-400'}`}
            >
        ...
        <div className="flex gap-3">
          <button
            ...
            onClick={async () => {
              setIsSyncing(true)
              const newOrders = await marketplaceSyncService.fetchOrders(
        ...
        <div className="glass p-6 border-l-4 border-blue-500">
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-2xl font-bold mt-1">
                ₹{reconciliationData.reduce((a, b) => a + parseFloat(b.fees), 0).toLocaleString()}
              </h3>
            </div>
