    ...
    <div className="margin-guard-view animate-fade">
      ...
      <div
        ...
        style={{
          marginTop: '32px',
          display: 'grid',
          gridTemplateColumns: flaggedOrders.length > 0 ? '1fr 1fr' : '1fr',
          gap: '24px',
        }}
      >
            ...
            {flaggedOrders.length === 0 ? (
              ...
              flaggedOrders.map((order) => (
                <div
                  ...
                  style={{ padding: '24px', borderLeft: '4px solid var(--danger)' }}
                >
                  <div
                    style={{
                      display: 'flex',
            ...
            <div style={{ marginTop: '24px' }}>
              ...
              <div style={{ marginTop: '32px' }}>
                ...
                >
                  ...
                  <li style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    <span style={{ color: 'var(--warning)' }}>●</span> Unexpected Shipping Surcharge
                    (Zone E)
                  </li>
                  <li style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    <span style={{ color: 'var(--primary)' }}>●</span> BOM Cost Mismatch in Parent
                    SKU
                  </li>
                </ul>
              </div>
