    ...
    <div className="demand-forecast animate-fade">
      ...
      {forecastData && !forecastData.error && (
        ...
        >
          <div
            className="glass"
            style={{ padding: '20px', borderLeft: '4px solid var(--primary)' }}
          >
            ...
            <h3
              style={{
                marginTop: '8px',
                color: forecastData.metrics.growthRate > 0 ? 'var(--success)' : 'var(--danger)',
              }}
            >
              {forecastData.metrics.growthRate > 0 ? '+' : ''}
              {forecastData.metrics.growthRate}%
            </h3>
          </div>
