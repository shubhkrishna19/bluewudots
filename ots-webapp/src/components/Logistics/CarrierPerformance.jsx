    ...
    <div className="carrier-performance animate-fade">
      ...
      >
        {carrierData.map((carrier, idx) => (
          <div
            key={carrier.name}
            className="carrier-card glass glass-hover"
            style={{ padding: '24px', borderTop: `4px solid ${COLORS[idx]}` }}
          >
            <div
              ...
              >
                ...
                <span
                  style={{
                    fontWeight: '700',
                    color:
                      carrier.deliveryRate > 95
                        ? 'var(--success)'
                        : carrier.deliveryRate > 90
                          ? 'var(--warning)'
                          : 'var(--danger)',
                  }}
                >
      ...
      <div className="glass" style={{ marginTop: '24px', padding: '24px' }}>
        ...
        >
          <div
            className="glass"
            style={{ padding: '16px', borderLeft: '4px solid var(--success)' }}
          >
          ...
          >
            ...
            <p className="text-muted">
              Use Delhivery for bulk shipments - best cost-delivery balance
            </p>
          </div>
          <div
            className="glass"
            style={{ padding: '16px', borderLeft: '4px solid var(--warning)' }}
          >
