...
const InternationalShipping = () => {
  ...
  return (
    <div className="international-shipping animate-fade">
            ...
            >
              ...
              >
                ...
                {idx === 0 && (
                  <span
                    className="badge"
                    style={{ background: 'var(--success)', fontSize: '0.65rem' }}
                  >
                    CHEAPEST
                  </span>
                )}
      ...
      {selectedRate && (
        <div
          className="booking-section glass"
          style={{ marginTop: '32px', padding: '24px', borderTop: '4px solid var(--primary)' }}
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              <h3>Book Shipment</h3>
              <p className="text-muted" style={{ marginTop: '4px' }}>
                {selectedRate.carrier} to {country} • {weight}kg • ₹
                {selectedRate.total.toLocaleString()}
              </p>
            </div>
            <button
              className="btn-primary glass-hover"
          ...
          {bookingStatus?.success && (
            <div
              className="booking-success animate-fade"
              style={{
                marginTop: '20px',
                padding: '16px',
            ...
            >
              ...
              <p>
                ...
                {new Date(bookingStatus.estimatedDelivery).toLocaleDateString('en-IN', {
                  day: '2-digit',
                  month: 'short',
                  year: 'numeric',
                })}
