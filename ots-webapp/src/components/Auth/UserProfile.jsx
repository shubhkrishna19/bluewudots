...
const UserProfile = ({ onClose }) => {
    ...
    return (
        <div className="user-profile-panel animate-fade" style={{
            position: 'fixed',
            top: 0,
            right: 0,
            bottom: 0,
            ...
            <div style={{ flex: 1, padding: '24px', overflowY: 'auto' }}>
                ...
                <div className="glass" style={{ padding: '16px', marginBottom: '20px' }}>
                    <p className="text-muted" style={{ fontSize: '0.75rem' }}>SESSION INFO</p>
                ...
                <div className="glass" style={{ padding: '16px' }}>
                    <p className="text-muted" style={{ fontSize: '0.75rem', marginBottom: '12px' }}>PERMISSIONS</p>
