...
const BulkActions = () => {
  ...
  const pendingOrders = orders.filter(
    (o) => o.status !== 'Delivered' && !o.status.startsWith('RTO') && o.status !== 'Cancelled'
  )
  ...
  return (
    <div className="bulk-actions animate-fade">
      ...
      {results && (
        <div
          className="results-banner glass animate-fade"
          style={{
            padding: '16px 20px',
            marginTop: '20px',
        ...
        {pendingOrders.map((order) => (
          ...
          >
            ...
            >
              <span
                className="badge"
                style={{ background: getStatusColor(order.status), fontSize: '0.7rem' }}
              >
