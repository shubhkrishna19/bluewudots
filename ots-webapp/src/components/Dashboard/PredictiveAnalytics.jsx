...
const PredictiveAnalytics = () => {
  ...
  return (
    <div className="predictive-analytics animate-fade">
      ...
      >
        <div
          className="projection-card glass glass-hover"
        ...
        >
          ...
          >
            <div>
              ...
              <h2 style={{ color: 'var(--success)', fontSize: '2.2rem', margin: '8px 0' }}>
        ...
        <div
          ...
          style={{ padding: '20px', borderRadius: '12px', borderLeft: '4px solid var(--primary)' }}
        >
      ...
      <div
        className="trend-visualization glass"
        style={{ padding: '20px', borderRadius: '12px', height: '320px' }}
      >
        <p
          className="text-muted"
          style={{
