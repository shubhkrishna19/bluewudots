...
const HelpCenter = () => {
  ...
  const faqs = [
    {
      q: 'How do I import orders from Amazon?',
      a: 'Go to Import → Select Amazon IN → Upload your CSV export from Seller Central.',
    },
    {
      q: 'Can I edit orders after import?',
      a: 'Orders are read-only in this version. Status can be changed via Bulk Actions or Order Journey.',
    },
    {
      q: 'How are carrier rates calculated?',
      a: 'Rates use base rate + weight-based additional charges + fuel surcharge + AWB fee.',
    },
    {
      q: 'Where is data stored?',
      a: 'Currently in browser memory. Zoho Catalyst integration for cloud persistence is planned.',
    },
  ]
        ...
        return (
          <div>
            ...
            <p style={{ marginTop: '16px', lineHeight: '1.8' }}>
              Bluewud OTS is an industrial-grade Order Tracking System designed for Pan-India
              logistics operations.
            </p>
            <div className="steps" style={{ marginTop: '24px' }}>
              <div className="step glass" style={{ padding: '16px', marginBottom: '12px' }}>
                <strong>Step 1:</strong> Import orders from your sales channels (Amazon, Flipkart,
                Shopify, etc.)
              </div>
              <div className="step glass" style={{ padding: '16px', marginBottom: '12px' }}>
                <strong>Step 2:</strong> System applies MTP (commercial logic) and recommends
                carriers
              </div>
              <div className="step glass" style={{ padding: '16px', marginBottom: '12px' }}>
        ...
        return (
          <div>
            ...
            <ul style={{ marginTop: '16px', paddingLeft: '20px', lineHeight: '2' }}>
              <li>
                <strong>Amazon IN</strong> - SP-API integration (OAuth)
              </li>
              <li>
                <strong>Flipkart</strong> - Seller Hub CSV export
              </li>
              <li>
                <strong>Shopify</strong> - Orders CSV export
              </li>
              <li>
                <strong>Urban Ladder</strong> - Manual CSV
              </li>
              <li>
                <strong>Pepperfry</strong> - Manual CSV
              </li>
              <li>
                <strong>IndiaMART</strong> - Lead CSV
              </li>
              <li>
                <strong>Local Shop</strong> - Quick Order form
              </li>
              <li>
                <strong>Dealer</strong> - Dealer order form
              </li>
            </ul>
          </div>
        )
      ...
      case 'dealers':
        return (
          <div>
            ...
            <p style={{ marginTop: '16px', lineHeight: '1.8' }}>
              Dealers are linked to your Zoho CRM Accounts module. The OTS app provides read-only
              access to dealer data.
            </p>
            <ul style={{ marginTop: '16px', paddingLeft: '20px', lineHeight: '2' }}>
              <li>
                <strong>Dealer Codes</strong> - Unique identifiers from CRM
              </li>
              <li>
                <strong>Relationship Types</strong> - Distributor, Retailer, Franchise
              </li>
              <li>
                <strong>Credit Limits</strong> - Managed in CRM
              </li>
              <li>
                <strong>Order History</strong> - View-only in this app
              </li>
            </ul>
          </div>
        )
