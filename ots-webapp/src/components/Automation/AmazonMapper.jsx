  ...
  return (
    <div className="mapper-container animate-fade">
      ...
      {activeTab === 'import' ? (
        <>
          <div
            className="mapping-dashboard grid"
            ...
            >
              {isUploading ? (
                ...
                <label style={{ cursor: 'pointer', width: '100%' }}>
                  ...
                  <p>
                    Drop Amazon Order CSV here or <strong>Browse</strong>
                  </p>
                  <span style={{ fontSize: '0.8rem', color: 'var(--primary)' }}>
                    Sync directly into Bluewud Data Lake
                  </span>
                </label>
              )}
            </div>
          ...
          <div className="mapping-rules glass" style={{ marginTop: '24px', padding: '24px' }}>
            ...
            >
              <div
                className="rule-card glass-hover"
