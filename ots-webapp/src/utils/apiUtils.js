 ...
 */
const retryWithBackoff = async (fn, maxRetries = MAX_RETRIES, delayMs = RETRY_DELAY_MS) => {
...
const fetchWithErrorHandling = async (endpoint, options = {}) => {
  ...
  try {
    ...
    throw new APIError(error.message || 'Network request failed', null, { originalError: error })
  }
}
...
export { request, get, post, put, patch, del, batch, queueForRetry, processQueue, APIError }
