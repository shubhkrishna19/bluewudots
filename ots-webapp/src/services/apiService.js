    ...
    async getOrders(params = {}) {
        try {
            const queryParams = new URLSearchParams({
                createdAfter: params.startDate || new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(),
                ...params
            });
