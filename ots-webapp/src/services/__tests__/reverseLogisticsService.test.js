...
describe('Reverse Logistics Service', () => {
    ...
    it('should create a return request with valid status', () => {
        const request = reverseLogisticsService.createReturnRequest('ORD-123', 'Damaged', [{ sku: 'SKU-1', qty: 1 }]);
    ...
    it('should throw error if order ID is missing', () => {
        expect(() => reverseLogisticsService.createReturnRequest(null, 'Reason'))
