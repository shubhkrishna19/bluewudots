...
const TEMPLATES = {
    invoice: {
        'en-IN': {
            title: 'TAX INVOICE',
            fields: { itemNo: 'Item No.', description: 'Description', qty: 'Qty', rate: 'Rate', amount: 'Amount' },
            footer: 'Thank you for your business!'
        },
        'en-US': {
            title: 'COMMERCIAL INVOICE',
            fields: { itemNo: 'Item #', description: 'Description', qty: 'Quantity', rate: 'Unit Price', amount: 'Total' },
            footer: 'Thank you for your order!'
        },
        'ar-AE': {
            title: 'فاتورة تجارية',
            fields: { itemNo: 'رقم الصنف', description: 'الوصف', qty: 'الكمية', rate: 'السعر', amount: 'المبلغ' },
