...
export const trackInternationalShipment = async (trackingNumber) => {
    ...
    return {
        ...
        events: [
            { timestamp: new Date().toISOString(), event: 'Shipment departed origin facility', location: 'Mumbai, India' },
            { timestamp: new Date(Date.now() - 86400000).toISOString(), event: 'Label created', location: 'Bangalore, India' }
        ]
    };
};
